<aside class="dashboard-sidebar offcanvas-lg offcanvas-start" tabindex="-1" id="dashboardSidebar" aria-labelledby="dashboardSidebarLabel">
    <div class="sidebar-inner">
        ...
        <nav class="sidebar-nav" aria-label="Dashboard navigation">
            ...
            <a class="sidebar-link {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}" href="{{ route('admin.categories.index') }}" @if(request()->routeIs('admin.categories.*')) aria-current="page" @endif><i class="bi bi-folder" aria-hidden="true"></i><span>Categories</span></a>
        </nav>
